  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "flex h-8 shrink-0 items-center rounded-md px-2 py-8 mb-2 text-md font-medium text-sidebar-foreground/70 outline-none border-b  ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
